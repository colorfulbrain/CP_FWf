...
##vol to common space
#mkdir -p $subjTAR/$subj/tau_bycerebelgm/reg_vol2fsaverage
#mri_vol2vol --mov $subjTAR/$subj/tau_bycerebelgm/mgx.subctxgm.nii.gz --reg $subjTAR/$subj/tau_bycerebelgm/aux/bbpet2anat.lta --tal --talres 2  --o $subjTAR/$subj/tau_bycerebelgm/reg_vol2fsaverage/subctxgm.mni305.2mm.sm00.nii.gz
#cd $subjTAR/$subj/tau_bycerebelgm/reg_vol2fsaverage
...
#export QC='/home/binyin/local4t/research/data_wash/RJ_uMR890_forAD/QC_coreg/tau'
#mkdir -p $QC

#freeview -viewport z -v $SUBJECTS_DIR/$subj/mri/orig.mgz:name=orig.mgz $subjDIR/$subj/MK6240/MK6540raw.nii.gz:name=MK6540raw.nii.gz:reg=$subjTAR/$subj/tau_bycerebelgm/toT1.reg.lta:colormap=NIH:opacity=0.15 --surface $SUBJECTS_DIR/$subj/surf/lh.white:edgecolor=yellow --surface $SUBJECTS_DIR/$subj/surf/lh.white:edgecolor=yellow -slice 90 90 90 -ss $QC/$subj.z.jpg

#freeview -viewport y -v $SUBJECTS_DIR/$subj/mri/orig.mgz:name=orig.mgz $subjDIR/$subj/MK6240/MK6540raw.nii.gz:name=MK6540raw.nii.gz:reg=$subjTAR/$subj/tau_bycerebelgm/toT1.reg.lta:colormap=NIH:opacity=0.15 --surface $SUBJECTS_DIR/$subj/surf/rh.white:edgecolor=yellow --surface $SUBJECTS_DIR/$subj/surf/rh.white:edgecolor=yellow -slice 90 90 90 -ss $QC/$subj.y.jpg
